                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: CustomIconButton(
                                ...
                                icon: GetBuilder<WeatherController>(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CustomIconButton(
                                  ...
                                  backgroundColor: Color(0xFF0172fb),
                                ),
                              ],
                            ).animate().fade().slideX(
                                  duration: 300.ms,
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              ...
                              16.horizontalSpace,
                              WeatherDetailsItem(
                                title: Strings.cloud.tr,
                                icon: Constants.wind,
                                value: controller.weatherDetails.current.cloud
                                    .toInt()
                                    .toString(),
                                text: '%',
                                isHalfCircle: true,
                              ...
                              16.horizontalSpace,
                              WeatherDetailsItem(
                                title: Strings.totalpercip.tr,
                                icon: Constants.pressure,
                                value:
                                    '${controller.weatherDetails.current.precipMm}',
                                text: 'Mm',
                                isHalfCircle: true,
                              ),
                            ],
